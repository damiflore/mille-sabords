System.register([], function (exports, module) {
  ...
  return {
    execute: function () {
      ...
      var _typeof = exports('Y', typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? nativeTypeOf : customTypeOf);
      ...
      */
      ...
      var react_development = createCommonjsModule(function (module, exports$1) {
        {
          (function () {
      ...
      var react = exports('r', createCommonjsModule(function (module) {
        {
      ...
      */ /* eslint-disable no-unused-vars */var getOwnPropertySymbols$1=Object.getOwnPropertySymbols;var hasOwnProperty$1=Object.prototype.hasOwnProperty;var propIsEnumerable$1=Object.prototype.propertyIsEnumerable;function toObject$1(val){if(val===null||val===undefined){throw new TypeError('Object.assign cannot be called with null or undefined');}return Object(val);}function shouldUseNative$1(){try{if(!Object.assign){return false;}// Detect buggy property enumeration order in older V8 versions.
      ...
      return false;}}var objectAssign$1=shouldUseNative$1()?Object.assign:function(target,source){var from;var to=toObject$1(target);var symbols;for(var s=1;s<arguments.length;s++){from=Object(arguments[s]);for(var key in from){if(hasOwnProperty$1.call(from,key)){to[key]=from[key];}}if(getOwnPropertySymbols$1){symbols=getOwnPropertySymbols$1(from);for(var i=0;i<symbols.length;i++){if(propIsEnumerable$1.call(from,symbols[i])){to[symbols[i]]=from[symbols[i]];}}}}return to;};var scheduler_production_min=createCommonjsModule$1(function(module,exports$1){var _f,g,h,k,l;if("undefined"===typeof window||"function"!==typeof MessageChannel){var p=null,q=null,t=function t(){if(null!==p)try{var a=exports$1.unstable_now();p(!0,a);p=null;}catch(b){throw setTimeout(t,0),b;}},u=Date.now();exports$1.unstable_now=function(){return Date.now()-u;};_f=function f(a){null!==p?setTimeout(_f,0,a):(p=a,setTimeout(t,0));};g=function g(a,b){q=setTimeout(a,b);};h=function h(){clearTimeout(q);};k=function k(){return !1;};l=exports$1.unstable_forceFrameRate=function(){};}else {var w=window.performance,x=window.Date,y=window.setTimeout,z=window.clearTimeout;if("undefined"!==typeof console){var A=window.cancelAnimationFrame;"function"!==typeof window.requestAnimationFrame&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://fb.me/react-polyfills");"function"!==typeof A&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://fb.me/react-polyfills");}if("object"===_typeof(w)&&"function"===typeof w.now)exports$1.unstable_now=function(){return w.now();};else {var B=x.now();exports$1.unstable_now=function(){return x.now()-B;};}var C=!1,D=null,E=-1,F=5,G=0;k=function k(){return exports$1.unstable_now()>=G;};l=function l(){};exports$1.unstable_forceFrameRate=function(a){0>a||125<a?console.error("forceFrameRate takes a positive int between 0 and 125, forcing framerates higher than 125 fps is not unsupported"):F=0<a?Math.floor(1E3/a):5;};var H=new MessageChannel(),I=H.port2;H.port1.onmessage=function(){if(null!==D){var a=exports$1.unstable_now();G=a+F;try{D(!0,a)?I.postMessage(null):(C=!1,D=null);}catch(b){throw I.postMessage(null),b;}}else C=!1;};_f=function _f(a){D=a;C||(C=!0,I.postMessage(null));};g=function g(a,b){E=y(function(){a(exports$1.unstable_now());},b);};h=function h(){z(E);E=-1;};}function J(a,b){var c=a.length;a.push(b);a:for(;;){var d=c-1>>>1,e=a[d];if(void 0!==e&&0<K(e,b))a[d]=b,a[c]=e,c=d;else break a;}}function L(a){a=a[0];return void 0===a?null:a;}function M(a){var b=a[0];if(void 0!==b){var c=a.pop();if(c!==b){a[0]=c;a:for(var d=0,e=a.length;d<e;){var m=2*(d+1)-1,n=a[m],v=m+1,r=a[v];if(void 0!==n&&0>K(n,c))void 0!==r&&0>K(r,n)?(a[d]=r,a[v]=c,d=v):(a[d]=n,a[m]=c,d=m);else if(void 0!==r&&0>K(r,c))a[d]=r,a[v]=c,d=v;else break a;}}return b;}return null;}function K(a,b){var c=a.sortIndex-b.sortIndex;return 0!==c?c:a.id-b.id;}var N=[],O=[],P=1,Q=null,R=3,S=!1,T=!1,U=!1;function V(a){for(var b=L(O);null!==b;){if(null===b.callback)M(O);else if(b.startTime<=a)M(O),b.sortIndex=b.expirationTime,J(N,b);else break;b=L(O);}}function W(a){U=!1;V(a);if(!T)if(null!==L(N))T=!0,_f(X);else {var b=L(O);null!==b&&g(W,b.startTime-a);}}function X(a,b){T=!1;U&&(U=!1,h());S=!0;var c=R;try{V(b);for(Q=L(N);null!==Q&&(!(Q.expirationTime>b)||a&&!k());){var d=Q.callback;if(null!==d){Q.callback=null;R=Q.priorityLevel;var e=d(Q.expirationTime<=b);b=exports$1.unstable_now();"function"===typeof e?Q.callback=e:Q===L(N)&&M(N);V(b);}else M(N);Q=L(N);}if(null!==Q)var m=!0;else {var n=L(O);null!==n&&g(W,n.startTime-b);m=!1;}return m;}finally{Q=null,R=c,S=!1;}}function Y(a){switch(a){case 1:return -1;case 2:return 250;case 5:return 1073741823;case 4:return 1E4;default:return 5E3;}}var Z=l;exports$1.unstable_IdlePriority=5;exports$1.unstable_ImmediatePriority=1;exports$1.unstable_LowPriority=4;exports$1.unstable_NormalPriority=3;exports$1.unstable_Profiling=null;exports$1.unstable_UserBlockingPriority=2;exports$1.unstable_cancelCallback=function(a){a.callback=null;};exports$1.unstable_continueExecution=function(){T||S||(T=!0,_f(X));};exports$1.unstable_getCurrentPriorityLevel=function(){return R;};exports$1.unstable_getFirstCallbackNode=function(){return L(N);};exports$1.unstable_next=function(a){switch(R){case 1:case 2:case 3:var b=3;break;default:b=R;}var c=R;R=b;try{return a();}finally{R=c;}};exports$1.unstable_pauseExecution=function(){};exports$1.unstable_requestPaint=Z;exports$1.unstable_runWithPriority=function(a,b){switch(a){case 1:case 2:case 3:case 4:case 5:break;default:a=3;}var c=R;R=a;try{return b();}finally{R=c;}};exports$1.unstable_scheduleCallback=function(a,b,c){var d=exports$1.unstable_now();if("object"===_typeof(c)&&null!==c){var e=c.delay;e="number"===typeof e&&0<e?d+e:d;c="number"===typeof c.timeout?c.timeout:Y(a);}else c=Y(a),e=d;c=e+c;a={id:P++,callback:b,priorityLevel:a,startTime:e,expirationTime:c,sortIndex:-1};e>d?(a.sortIndex=e,J(O,a),null===L(N)&&a===L(O)&&(U?h():U=!0,g(W,e-d))):(a.sortIndex=c,J(N,a),T||S||(T=!0,_f(X)));return a;};exports$1.unstable_shouldYield=function(){var a=exports$1.unstable_now();V(a);var b=L(N);return b!==Q&&null!==Q&&null!==b&&null!==b.callback&&b.startTime<=a&&b.expirationTime<Q.expirationTime||k();};exports$1.unstable_wrapCallback=function(a){var b=R;return function(){var c=R;R=b;try{return a.apply(this,arguments);}finally{R=c;}};};});var scheduler_development=createCommonjsModule$1(function(module,exports$1){{(function(){var enableSchedulerDebugging=false;var enableProfiling=true;var _requestHostCallback;var requestHostTimeout;var cancelHostTimeout;var shouldYieldToHost;var requestPaint;if(// If Scheduler runs in a non-DOM environment, it falls back to a naive
      ...
      var _callback=null;var _timeoutID=null;var _flushCallback=function _flushCallback(){if(_callback!==null){try{var currentTime=exports$1.unstable_now();var hasRemainingTime=true;_callback(hasRemainingTime,currentTime);_callback=null;}catch(e){setTimeout(_flushCallback,0);throw e;}}};var initialTime=Date.now();exports$1.unstable_now=function(){return Date.now()-initialTime;};_requestHostCallback=function requestHostCallback(cb){if(_callback!==null){// Protect against re-entrancy.
      setTimeout(_requestHostCallback,0,cb);}else {_callback=cb;setTimeout(_flushCallback,0);}};requestHostTimeout=function requestHostTimeout(cb,ms){_timeoutID=setTimeout(cb,ms);};cancelHostTimeout=function cancelHostTimeout(){clearTimeout(_timeoutID);};shouldYieldToHost=function shouldYieldToHost(){return false;};requestPaint=exports$1.unstable_forceFrameRate=function(){};}else {// Capture local references to native APIs, in case a polyfill overrides them.
      ...
      console['error']("This browser doesn't support cancelAnimationFrame. "+'Make sure that you load a '+'polyfill in older browsers. https://fb.me/react-polyfills');}}if(_typeof(performance)==='object'&&typeof performance.now==='function'){exports$1.unstable_now=function(){return performance.now();};}else {var _initialTime=_Date.now();exports$1.unstable_now=function(){return _Date.now()-_initialTime;};}var isMessageLoopRunning=false;var scheduledHostCallback=null;var taskTimeoutID=-1;// Scheduler periodically yields in case there is other work on the main
      ...
      shouldYieldToHost=function shouldYieldToHost(){return exports$1.unstable_now()>=deadline;};// Since we yield every frame regardless, `requestPaint` has no effect.
      requestPaint=function requestPaint(){};}exports$1.unstable_forceFrameRate=function(fps){if(fps<0||fps>125){// Using console['error'] to evade Babel and ESLint
      ...
      yieldInterval=5;}};var performWorkUntilDeadline=function performWorkUntilDeadline(){if(scheduledHostCallback!==null){var currentTime=exports$1.unstable_now();// Yield after `yieldInterval` ms, regardless of where we are in the vsync
       ...
       * @param {?Function} getStack Returns the component stack.
       * @private
       */function checkPropTypes$1(typeSpecs,values,location,componentName,getStack){{for(var typeSpecName in typeSpecs){if(has$1(typeSpecs,typeSpecName)){var error;// Prop type validation may throw. In case they do, we don't want to
      // fail the render phase where it didn't fail before. So we log it.
      // After these have been cleaned up, we'll let them throw.
      ...
      // same error.
      loggedTypeFailures$1[error.message]=true;var stack=getStack?getStack():'';printWarning$1('Failed '+location+' type: '+error.message+(stack!=null?stack:''));}}}}}/**
       * Resets warning cache when testing.
       *
       * @private
       */checkPropTypes$1.resetWarningCache=function(){{loggedTypeFailures$1={};}};var checkPropTypes_1$1=checkPropTypes$1;var schedulerTracing_development=createCommonjsModule$1(function(module,exports){{(function(){var DEFAULT_THREAD_ID=0;// Counters used to generate unique IDs.
      ...
      // a globalThis event handler. But because the error happens in a different
      ...
      if(!(typeof document!=='undefined')){{throw Error("The `document` globalThis was defined when React was initialized, but is not defined anymore. This can happen in a test environment if a component schedules an update from an asynchronous callback, but the test has already finished running. To solve this, you can either unmount the component at the end of your test (and ensure that any asynchronous operations get canceled in `componentWillUnmount`), or you can change the test itself to be asynchronous.");}}var evt=document.createEvent('Event');// Keeps track of whether the user-provided callback threw an error. We
      // set this to true at the beginning, then set it to false right after
      // calling the function. If the function errors, `didError` will never be
      // set to false. This strategy works even if the browser is flaky and
      // fails to call our globalThis error handler, because it doesn't rely on
      ...
      if(typeof window.event!=='undefined'&&window.hasOwnProperty('event')){window.event=windowEvent;}func.apply(context,funcArgs);didError=false;}// Create a globalThis error event handler. We use this to capture the value
      ...
      // errors, it will trigger our globalThis error handler.
       ...
       * it in a globalThis so it can be rethrown by `rethrowCaughtError` later.
      ...
      }finally{{ReactCurrentDispatcher.current=prevDispatcher;}}}}{// $FlowExpectedError - jest isn't a globalThis, and isn't recognized outside of tests
      ...
      // It should probably use a globalThis start time value instead.
      }// Pop a row.
      ...
      console.info('%cDownload the React DevTools '+'for a better development experience: '+'https://fb.me/react-devtools'+(protocol==='file:'?'\nYou might need to use a local HTTP server (instead of file://): '+'https://fb.me/react-devtools-faq':''),'font-weight:bold');}}}}exports$1.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=Internals;exports$1.createPortal=createPortal$1;exports$1.findDOMNode=findDOMNode;exports$1.flushSync=flushSync;exports$1.hydrate=hydrate;exports$1.render=render;exports$1.unmountComponentAtNode=unmountComponentAtNode;exports$1.unstable_batchedUpdates=batchedUpdates$1;exports$1.unstable_createPortal=unstable_createPortal;exports$1.unstable_renderSubtreeIntoContainer=renderSubtreeIntoContainer;exports$1.version=ReactVersion;})();}});var reactDom=exports('b', createCommonjsModule$1(function(module){{module.exports=reactDom_development;}}));
      ...
      var createLogger = exports('O', function createLogger() {
      ...
      var _defineProperty = exports('a', (function (obj, key, value) {
      ...
      var _slicedToArray = exports('N', (function (arr, i) {
      ...
      var createStructuredStateStore = function createStructuredStateStore(defaultState, init) {
        var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
            _ref$name = _ref.name,
            name = _ref$name === void 0 ? "global" : _ref$name,
            _ref$effect = _ref.effect,
            effect = _ref$effect === void 0 ? function () {} : _ref$effect;

        var StateContextMap = {};
        var stateKeys = Object.keys(defaultState);
        stateKeys.forEach(function (key) {
          var KeyedStateContext = createContext(defaultState[key]);
          StateContextMap[key] = KeyedStateContext;
          KeyedStateContext.Provider.displayName = "".concat(name, ".state.").concat(key, ".Provider");
        });
        ...
        var getStateInternal = function getStateInternal() {
          return defaultState;
        ...
        var Provider = function Provider(_ref2) {
          ...
          var _useReducer = useReducer(reducer, defaultState, init),
              _useReducer2 = _slicedToArray(_useReducer, 2),
              state = _useReducer2[0],
              dispatch = _useReducer2[1];

          getStateInternal = function getStateInternal() {
            return state;
          };
          ...
          var DispatchProvider = DispatchContext.Provider;
          DispatchProvider.displayName = "".concat(name, ".dispatch.Provider"); // nested provider info: https://github.com/facebook/react/issues/14620

          var element = /*#__PURE__*/react.createElement(DispatchProvider, {
            value: dispatch
          }, children);
          return stateKeys.reduce(function (element, key) {
            var KeyedStateProvider = StateContextMap[key].Provider;
            return /*#__PURE__*/react.createElement(KeyedStateProvider, {
              value: state[key]
            }, element);
          }, element);
        };
        ...
        var useKeyedState = function useKeyedState(key) {
        ...
        var createAction = function createAction(actionReducer) {
          return function () {
            ...
            return function () {
              ...
              dispatch(function (state) {
                return actionReducer.apply(void 0, [state].concat(args));
              });
            };
          };
        };
      ...
      var _toConsumableArray = exports('d', (function (arr) {
        return arrayWithoutHoles(arr) || iterableToArray(arr) || unsupportedIterableToArray(arr) || nonIterableSpread();
      }));

      var _createDeck, _cardColors;

      var CARD_ANIMALS = "animals";
      var CARD_CHEST = "chest";
      var CARD_COIN = "coin";
      var CARD_DIAMOND = "diamond";
      var CARD_PIRATE = "pirate";
      var CARD_WITCH = "witch";
      var CARD_ONE_SKULL = "1skull";
      var CARD_TWO_SKULLS = "2skulls";
      var CARD_TWO_SWORDS_CHALLENGE = "2sword-challenge";
      var CARD_THREE_SWORDS_CHALLENGE = "3sword-challenge";
      var CARD_FOUR_SWORDS_CHALLENGE = "4sword-challenge";
      var createDeck = function createDeck(repartition) {
        var cards = [];
        Object.keys(repartition).forEach(function (cardType) {
          var quantity = repartition[cardType];
      ...
      var CARDS = createDeck((_createDeck = {}, _defineProperty(_createDeck, CARD_PIRATE, 4), _defineProperty(_createDeck, CARD_WITCH, 4), _defineProperty(_createDeck, CARD_CHEST, 4), _defineProperty(_createDeck, CARD_ANIMALS, 4), _defineProperty(_createDeck, CARD_DIAMOND, 4), _defineProperty(_createDeck, CARD_COIN, 3), _defineProperty(_createDeck, CARD_ONE_SKULL, 3), _defineProperty(_createDeck, CARD_TWO_SKULLS, 2), _defineProperty(_createDeck, CARD_TWO_SWORDS_CHALLENGE, 2), _defineProperty(_createDeck, CARD_THREE_SWORDS_CHALLENGE, 3), _defineProperty(_createDeck, CARD_FOUR_SWORDS_CHALLENGE, 4), _createDeck));
      var mixDeck = exports('J', function mixDeck(deck) {
        var deckMixed = _toConsumableArray(deck);

        for (var i = 0; i < 100; i++) {
          swapTwoCards(deckMixed);
        }

        return deckMixed;
      });

      var swapTwoCards = function swapTwoCards(deck) {
        // pick two random indexes
        var index1 = randomIndex(deck.length);
        var index2 = randomIndex(deck.length); // swap cards at these indexes
      ...
      var randomIndex = function randomIndex(arrayLength) {
        return Math.floor(Math.random() * arrayLength);
      };

      var isPirateCard = exports('k', function isPirateCard(card) {
        return card === CARD_PIRATE;
      });
      var isWitchCard = exports('A', function isWitchCard(card) {
        return card === CARD_WITCH;
      });
      var isChestCard = exports('C', function isChestCard(card) {
        return card === CARD_CHEST;
      });
      var isAnimalsCard = exports('h', function isAnimalsCard(card) {
        return card === CARD_ANIMALS;
      });
      var isDiamondCard = exports('m', function isDiamondCard(card) {
        return card === CARD_DIAMOND;
      });
      var isCoinCard = exports('l', function isCoinCard(card) {
        return card === CARD_COIN;
      });
      var isOneSkullCard = exports('E', function isOneSkullCard(card) {
        return card === CARD_ONE_SKULL;
      });
      var isTwoSkullsCard = exports('H', function isTwoSkullsCard(card) {
        return card === CARD_TWO_SKULLS;
      });
      var isTwoSwordsChallengeCard = exports('i', function isTwoSwordsChallengeCard(card) {
        return card === CARD_TWO_SWORDS_CHALLENGE;
      });
      var isThreeSwordsChallengeCard = exports('e', function isThreeSwordsChallengeCard(card) {
        return card === CARD_THREE_SWORDS_CHALLENGE;
      });
      var isFourSwordsChallengeCard = exports('g', function isFourSwordsChallengeCard(card) {
        return card === CARD_FOUR_SWORDS_CHALLENGE;
      });
      var isSwordChallengeCard = exports('L', function isSwordChallengeCard(card) {
        return isTwoSwordsChallengeCard(card) || isThreeSwordsChallengeCard(card) || isFourSwordsChallengeCard(card);
      });
      var TWO_SWORDS_CHALLENGE_GAMBLE = exports('T', {
        numberOfSwords: 2,
        gambleAmount: 300
      });
      var THREE_SWORDS_CHALLENGE_GAMBLE = exports('f', {
        numberOfSwords: 3,
        gambleAmount: 500
      });
      var FOUR_SWORDS_CHALLENGE_GAMBLE = exports('F', {
        numberOfSwords: 4,
        gambleAmount: 1000
      });
      var cardColors = exports('$', (_cardColors = {}, _defineProperty(_cardColors, CARD_PIRATE, {
        color1: "#E6A9AB",
        color2: "#C1272D"
      }), _defineProperty(_cardColors, CARD_WITCH, {
        color1: "#757092",
        color2: "#482399"
      }), _defineProperty(_cardColors, CARD_CHEST, {
        color1: "#C69C6D",
        color2: "#8C6239"
      }), _defineProperty(_cardColors, CARD_ANIMALS, {
        color1: "#99D380",
        color2: "#39B100"
      }), _defineProperty(_cardColors, CARD_DIAMOND, {
        color1: "#95C1E5",
        color2: "#3E57A6"
      }), _defineProperty(_cardColors, CARD_COIN, {
        color1: "#FFF5BB",
        color2: "#CE9109"
      }), _defineProperty(_cardColors, CARD_ONE_SKULL, {
        color1: "#666666",
        color2: "#000000"
      }), _defineProperty(_cardColors, CARD_TWO_SKULLS, {
        color1: "#666666",
        color2: "#000000"
      }), _defineProperty(_cardColors, CARD_TWO_SWORDS_CHALLENGE, {
        color1: "#F4B392",
        color2: "#CB6828"
      }), _defineProperty(_cardColors, CARD_THREE_SWORDS_CHALLENGE, {
        color1: "#F4B392",
        color2: "#CB6828"
      }), _defineProperty(_cardColors, CARD_FOUR_SWORDS_CHALLENGE, {
        color1: "#F4B392",
        color2: "#CB6828"
      }), _cardColors));
      var cardList = exports('M', [CARD_PIRATE, CARD_WITCH, CARD_CHEST, CARD_ANIMALS, CARD_DIAMOND, CARD_COIN, CARD_ONE_SKULL, CARD_TWO_SKULLS, CARD_TWO_SWORDS_CHALLENGE, CARD_THREE_SWORDS_CHALLENGE, CARD_FOUR_SWORDS_CHALLENGE]);

      var SYMBOL_COIN = exports('o', "coin");
      var SYMBOL_DIAMOND = exports('n', "diamond");
      var SYMBOL_MONKEY = exports('j', "monkey");
      var SYMBOL_PARROT = exports('S', "parrot");
      var SYMBOL_SKULL = exports('G', "skull");
      var SYMBOL_SWORD = exports('p', "sword");
      var symbolIsSkull = exports('s', function symbolIsSkull(symbol) {
        return symbol === SYMBOL_SKULL;
      });

      var faces = [SYMBOL_COIN, SYMBOL_DIAMOND, SYMBOL_MONKEY, SYMBOL_PARROT, SYMBOL_SKULL, SYMBOL_SWORD]; // Don't use an id: 0
      // Otherwise if(witchUncursedDiceId) would return false and we would have to check
      // if (typeof witchUncursedDiceId === 'number')

      var diceId = 1;
      var createDice = function createDice(props) {
      ...
      var DICES = [createDice(), createDice(), createDice(), createDice(), createDice(), createDice(), createDice(), createDice()];
      var diceIsOnSkull = exports('q', function diceIsOnSkull(dice) {
        return diceToVisibleSymbol(dice) === SYMBOL_SKULL;
      });
      var diceToVisibleSymbol = exports('D', function diceToVisibleSymbol(_ref) {
        var faces = _ref.faces,
            visibleFaceIndex = _ref.visibleFaceIndex;
      ...
      var stateStorageKey = "game";
      var store = createStructuredStateStore(defaultState, function () {
        if (localStorage.hasOwnProperty(stateStorageKey)) {
          var valueFromStorage = JSON.parse(localStorage.getItem(stateStorageKey)); // idéalement on voudrait plus qu'un log ici
          ...
          var missingKey = Object.keys(defaultState).find(function (key) {
            return key in valueFromStorage === false;
          });

          if (missingKey) {
            logger.warn("stored game state is missing a property (".concat(missingKey, ") -> use initial game state instead"));
            return defaultState;
          }

          var extraKey = Object.keys(valueFromStorage).find(function (key) {
            return key in defaultState === false;
          });

          if (extraKey) {
            logger.warn("stored game state contains an unknown property (".concat(extraKey, ") -> use initial game state instead"));
            return defaultState;
          }

          logger.info("read storage ".concat(stateStorageKey, " = "), valueFromStorage);
        ...
        effect: function effect(state) {
          logger.debug("store ".concat(stateStorageKey, " = "), state);
          localStorage.setItem(stateStorageKey, JSON.stringify(state));
        }
      });
      store.Provider.displayName = "storeProvider";
      var createAction = exports('c', store.createAction);
      var useGameStarted = exports('a2', function useGameStarted() {
        return store.useKeyedState("gameStarted");
      });
      var usePlayers = exports('t', function usePlayers() {
        return store.useKeyedState("players");
      });
      var useCurrentPlayerId = exports('u', function useCurrentPlayerId() {
        return store.useKeyedState("currentPlayerId");
      });
      var useCardDeck = exports('a0', function useCardDeck() {
        return store.useKeyedState("cardDeck");
      });
      var useRoundStarted = exports('Z', function useRoundStarted() {
        return store.useKeyedState("roundStarted");
      });
      var useRollCount = exports('v', function useRollCount() {
        return store.useKeyedState("rollCount");
      });
      var useScoreMarked = exports('B', function useScoreMarked() {
        return store.useKeyedState("scoreMarked");
      });
      var useIsOnSkullIsland = exports('K', function useIsOnSkullIsland() {
        return store.useKeyedState("isOnSkullIsland");
      });
      var useCurrentCard = exports('z', function useCurrentCard() {
        return store.useKeyedState("currentCard");
      });
      var useWitchUncursedDiceId = exports('x', function useWitchUncursedDiceId() {
        return store.useKeyedState("witchUncursedDiceId");
      });
      var useDicesRolled = exports('w', function useDicesRolled() {
        return store.useKeyedState("dicesRolled");
      });
      var useDicesCursed = exports('y', function useDicesCursed() {
        return store.useKeyedState("dicesCursed");
      });
      var useChestSlots = exports('I', function useChestSlots() {
        return store.useKeyedState("chestSlots");
      });

      var createContext$1 = react.createContext,
          useContext$1 = react.useContext,
          useState = react.useState;
      var MainDomNodeContext = createContext$1();
      var useMainDomNode = exports('P', function useMainDomNode() {
        return useContext$1(MainDomNodeContext)[0];
      });
      var useMainDomNodeSetter = exports('a1', function useMainDomNodeSetter() {
        return useContext$1(MainDomNodeContext)[1];
      });
      var diceDomNodeContexts = {};
      DICES.forEach(function (dice) {
        diceDomNodeContexts[dice.id] = createContext$1();
      });
      var diceDomNodeProviders = Object.keys(diceDomNodeContexts).map(function (key) {
        return diceDomNodeContexts[key].Provider;
      });

      var DiceDomNodesProvider = function DiceDomNodesProvider(_ref) {
        var children = _ref.children;
        return diceDomNodeProviders.reduceRight(function (prev, Next) {
          return /*#__PURE__*/react.createElement(Next, {
            value: useState()
          }, prev);
        }, children);
      };

      var useDiceDomNode = exports('Q', function useDiceDomNode(id) {
        return useContext$1(diceDomNodeContexts[id])[0];
      });
      var useDiceDomNodeSetter = exports('R', function useDiceDomNodeSetter(id) {
        return useContext$1(diceDomNodeContexts[id])[1];
      });
      var RolledAreaDomNodeContext = createContext$1();
      var useRolledAreaDomNode = exports('V', function useRolledAreaDomNode() {
        return useContext$1(RolledAreaDomNodeContext)[0];
      });
      var useRolledAreaDomNodeSetter = exports('X', function useRolledAreaDomNodeSetter() {
        return useContext$1(RolledAreaDomNodeContext)[1];
      });
      var DomNodesProvider = function DomNodesProvider(_ref2) {
        var children = _ref2.children;
        return /*#__PURE__*/react.createElement(MainDomNodeContext.Provider, {
          value: useState()
        }, /*#__PURE__*/react.createElement(RolledAreaDomNodeContext.Provider, {
          value: useState()
        }, /*#__PURE__*/react.createElement(DiceDomNodesProvider, null, children)));
      };

      var createContext$2 = react.createContext,
          useContext$2 = react.useContext,
          useState$1 = react.useState;
      var DragDiceGestureContext = createContext$2();
      var useDragDiceGesture = exports('W', function useDragDiceGesture() {
        return useContext$2(DragDiceGestureContext)[0];
      });
      var useDragDiceGestureSetter = exports('U', function useDragDiceGestureSetter() {
        return useContext$2(DragDiceGestureContext)[1];
      });
      var DragDiceGestureProvider = function DragDiceGestureProvider(_ref) {
        var children = _ref.children;
        return /*#__PURE__*/react.createElement(DragDiceGestureContext.Provider, {
          value: useState$1()
        }, children);
      };
      ...
      var ContextProvider = function ContextProvider(_ref) {
        ...
        }, /*#__PURE__*/react.createElement(DomNodesProvider, null, /*#__PURE__*/react.createElement(DragDiceGestureProvider, null, children)));
      };
      ...
      var createMilleSabordGame = _async(function (_ref) {
        var into = _ref.into;
        return _await(module.import('./main.component-a1a57ec9.js'), function (_ref2) {
          var Main = _ref2.Main;
          reactDom.render( /*#__PURE__*/react.createElement(ContextProvider, null, /*#__PURE__*/react.createElement(Main, null)), into);
        });
      });
...
//# sourceMappingURL=index-00c14db8.js.map
