System.register([__v__("/js/vendors.nomodule.js"), __v__("/js/app.nomodule.js")], function (_export, _context) {
  ...
  return {
    setters: [function (_vendorsJs) {
      ...
      loadImage = _appJs.loadImage;
      useUrlLoadingNotifier = _appJs.useUrlLoadingNotifier;
      symbolSwordUrl = _appJs.symbolSwordUrl;
      createAction = _appJs.createAction;
      diceToVisibleSymbol = _appJs.diceToVisibleSymbol;
      isSwordChallengeCard = _appJs.isSwordChallengeCard;
      isAnimalsCard = _appJs.isAnimalsCard;
      SYMBOL_PARROT = _appJs.SYMBOL_PARROT;
      SYMBOL_MONKEY = _appJs.SYMBOL_MONKEY;
      isPirateCard = _appJs.isPirateCard;
      isCoinCard = _appJs.isCoinCard;
      isDiamondCard = _appJs.isDiamondCard;
      SYMBOL_DIAMOND = _appJs.SYMBOL_DIAMOND;
      SYMBOL_COIN = _appJs.SYMBOL_COIN;
      SYMBOL_SWORD = _appJs.SYMBOL_SWORD;
      useCurrentPlayerId = _appJs.useCurrentPlayerId;
      usePlayers = _appJs.usePlayers;
      useCardIds = _appJs.useCardIds;
      cardIdToCard = _appJs.cardIdToCard;
      useRollCount = _appJs.useRollCount;
      useDices = _appJs.useDices;
      useChestSlots = _appJs.useChestSlots;
      useDiceRolledIds = _appJs.useDiceRolledIds;
      useWitchUncursedDiceId = _appJs.useWitchUncursedDiceId;
      diceIsOnSkull = _appJs.diceIsOnSkull;
      useDiceCursedIds = _appJs.useDiceCursedIds;
      symbolIsSkull = _appJs.symbolIsSkull;
      useCurrentCardId = _appJs.useCurrentCardId;
      isOneSkullCard = _appJs.isOneSkullCard;
      SYMBOL_SKULL = _appJs.SYMBOL_SKULL;
      isTwoSkullsCard = _appJs.isTwoSkullsCard;
      useScoreMarked = _appJs.useScoreMarked;
      isChestCard = _appJs.isChestCard;
      useAnimationsDisabled = _appJs.useAnimationsDisabled;
      useIsOnSkullIsland = _appJs.useIsOnSkullIsland;
      mixDeck = _appJs.mixDeck;
      useCurrentCardActivated = _appJs.useCurrentCardActivated;
      addLoadedListener = _appJs.addLoadedListener;
      isFocusable = _appJs.isFocusable;
      getStyleValue = _appJs.getStyleValue;
      isDocumentElement = _appJs.isDocumentElement;
      useMainDomNode = _appJs.useMainDomNode;
      symbolCoinUrl = _appJs.symbolCoinUrl;
      symbolDiamondUrl = _appJs.symbolDiamondUrl;
      getDocumentScroll = _appJs.getDocumentScroll;
      symbolToImageUrl = _appJs.symbolToImageUrl;
      SYMBOLS = _appJs.SYMBOLS;
      symbolIsMonkey = _appJs.symbolIsMonkey;
      symbolIsParrot = _appJs.symbolIsParrot;
      symbolIsCoin = _appJs.symbolIsCoin;
      symbolIsDiamond = _appJs.symbolIsDiamond;
      cardToImageUrl = _appJs.cardToImageUrl;
      cardToSmallImageUrl = _appJs.cardToSmallImageUrl;
      cardDefaultUrl = _appJs.cardDefaultUrl;
      symbolSkullUrl = _appJs.symbolSkullUrl;
      isWitchCard = _appJs.isWitchCard;
      addDomEventListener = _appJs.addDomEventListener;
      useDiceDomNode = _appJs.useDiceDomNode;
      useDiceDomNodeSetter = _appJs.useDiceDomNodeSetter;
      useWitchCardEffectUsed = _appJs.useWitchCardEffectUsed;
      useRoundStarted = _appJs.useRoundStarted;
      CARD_TWO_SWORDS_CHALLENGE = _appJs.CARD_TWO_SWORDS_CHALLENGE;
      useGameStarted = _appJs.useGameStarted;
      defaultState = _appJs.defaultState;
      swFacade = _appJs.swFacade;
      useSoundDisabled = _appJs.useSoundDisabled;
      symbolMonkeyUrl = _appJs.symbolMonkeyUrl;
      useMainDomNodeSetter = _appJs.useMainDomNodeSetter;
      useGameCreated = _appJs.useGameCreated;
    }],
    execute: function () {
      cache = new Map();
      Status = {
