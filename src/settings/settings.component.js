...
import { useDisableAnimations, useEnableAnimations, useDisableSound, useEnableSound, useCancelGame } from "src/main.actions.js"
  ...
  return (
    ...
    >
      <div className="settings-dialog-content">
        ...
        <div className="dialog-simple-title">
          Settings
        </div>
        ...
        <div className="setting-element">
          <button onClick={() => { requestCancelGame() }}>Annuler la partie</button>
        </div>
...
const ConfirmCancelGameDialog = ({ confirmCancelGameDialogIsOpen, closeConfirmCancelGameDialog, performCancelGame }) => {
  return (
    <Dialog
