System.register([__v__("/js/vendors.nomodule.js"), __v__("/js/app.nomodule.js")], function (_export, _context) {
  ...
  return {
    setters: [function (_vendorsJs) {
      ...
      loadImage = _appJsx.loadImage;
      useUrlLoadingNotifier = _appJsx.useUrlLoadingNotifier;
      symbolSwordUrl = _appJsx.symbolSwordUrl;
      createAction = _appJsx.createAction;
      diceToVisibleSymbol = _appJsx.diceToVisibleSymbol;
      isSwordChallengeCard = _appJsx.isSwordChallengeCard;
      isAnimalsCard = _appJsx.isAnimalsCard;
      SYMBOL_PARROT = _appJsx.SYMBOL_PARROT;
      SYMBOL_MONKEY = _appJsx.SYMBOL_MONKEY;
      isPirateCard = _appJsx.isPirateCard;
      isCoinCard = _appJsx.isCoinCard;
      isDiamondCard = _appJsx.isDiamondCard;
      SYMBOL_SWORD = _appJsx.SYMBOL_SWORD;
      SYMBOL_DIAMOND = _appJsx.SYMBOL_DIAMOND;
      SYMBOL_COIN = _appJsx.SYMBOL_COIN;
      useCurrentPlayerId = _appJsx.useCurrentPlayerId;
      usePlayers = _appJsx.usePlayers;
      useCardIds = _appJsx.useCardIds;
      cardIdToCard = _appJsx.cardIdToCard;
      useRollCount = _appJsx.useRollCount;
      useDices = _appJsx.useDices;
      useChestSlots = _appJsx.useChestSlots;
      useDiceRolledIds = _appJsx.useDiceRolledIds;
      useWitchUncursedDiceId = _appJsx.useWitchUncursedDiceId;
      diceIsOnSkull = _appJsx.diceIsOnSkull;
      useDiceCursedIds = _appJsx.useDiceCursedIds;
      symbolIsSkull = _appJsx.symbolIsSkull;
      useCurrentCardId = _appJsx.useCurrentCardId;
      isOneSkullCard = _appJsx.isOneSkullCard;
      SYMBOL_SKULL = _appJsx.SYMBOL_SKULL;
      isTwoSkullsCard = _appJsx.isTwoSkullsCard;
      useScoreMarked = _appJsx.useScoreMarked;
      isChestCard = _appJsx.isChestCard;
      useAnimationsDisabled = _appJsx.useAnimationsDisabled;
      useIsOnSkullIsland = _appJsx.useIsOnSkullIsland;
      mixDeck = _appJsx.mixDeck;
      useCurrentCardActivated = _appJsx.useCurrentCardActivated;
      addLoadedListener = _appJsx.addLoadedListener;
      isFocusable = _appJsx.isFocusable;
      getStyleValue = _appJsx.getStyleValue;
      isDocumentElement = _appJsx.isDocumentElement;
      useMainDomNode = _appJsx.useMainDomNode;
      symbolCoinUrl = _appJsx.symbolCoinUrl;
      symbolDiamondUrl = _appJsx.symbolDiamondUrl;
      getDocumentScroll = _appJsx.getDocumentScroll;
      symbolToImageUrl = _appJsx.symbolToImageUrl;
      SYMBOLS = _appJsx.SYMBOLS;
      symbolIsMonkey = _appJsx.symbolIsMonkey;
      symbolIsParrot = _appJsx.symbolIsParrot;
      symbolIsCoin = _appJsx.symbolIsCoin;
      symbolIsDiamond = _appJsx.symbolIsDiamond;
      cardToImageUrl = _appJsx.cardToImageUrl;
      cardToSmallImageUrl = _appJsx.cardToSmallImageUrl;
      cardDefaultUrl = _appJsx.cardDefaultUrl;
      symbolSkullUrl = _appJsx.symbolSkullUrl;
      isWitchCard = _appJsx.isWitchCard;
      addDomEventListener = _appJsx.addDomEventListener;
      useDiceDomNode = _appJsx.useDiceDomNode;
      useDiceDomNodeSetter = _appJsx.useDiceDomNodeSetter;
      useWitchCardEffectUsed = _appJsx.useWitchCardEffectUsed;
      useRoundStarted = _appJsx.useRoundStarted;
      CARD_TWO_SWORDS_CHALLENGE = _appJsx.CARD_TWO_SWORDS_CHALLENGE;
      useGameStarted = _appJsx.useGameStarted;
      defaultState = _appJsx.defaultState;
      swFacade = _appJsx.swFacade;
      useSoundDisabled = _appJsx.useSoundDisabled;
      symbolMonkeyUrl = _appJsx.symbolMonkeyUrl;
      useMainDomNodeSetter = _appJsx.useMainDomNodeSetter;
      useGameCreated = _appJsx.useGameCreated;
    }],
    execute: function () {
      cache = new Map();
      Status = {
