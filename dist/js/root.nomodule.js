System.register([__v__("/js/vendors.nomodule.js"), __v__("/js/app.nomodule.js")], function (_export, _context) {
  ...
  return {
    setters: [function (_vendorsJs) {
      ...
      jsxs = _vendorsJs.e;
      __jsenv_default_import__$1 = _vendorsJs.g;
      Fragment = _vendorsJs.F;
      createLogger = _vendorsJs.c;
      addToHomescreen = _vendorsJs.h;
    }, function (_appJs) {
      loadImage = _appJs.l;
      useUrlLoadingNotifier = _appJs.u;
      symbolSwordUrl = _appJs.s;
      createAction = _appJs.c;
      diceToVisibleSymbol = _appJs.d;
      isSwordChallengeCard = _appJs.i;
      isAnimalsCard = _appJs.a;
      SYMBOL_PARROT = _appJs.S;
      SYMBOL_MONKEY = _appJs.b;
      isPirateCard = _appJs.e;
      isCoinCard = _appJs.f;
      isDiamondCard = _appJs.g;
      SYMBOL_DIAMOND = _appJs.h;
      SYMBOL_COIN = _appJs.j;
      SYMBOL_SWORD = _appJs.k;
      useCurrentPlayerId = _appJs.m;
      usePlayers = _appJs.n;
      useCardIds = _appJs.o;
      cardIdToCard = _appJs.p;
      useRollCount = _appJs.q;
      useDices = _appJs.r;
      useChestSlots = _appJs.t;
      useDiceRolledIds = _appJs.v;
      useWitchUncursedDiceId = _appJs.w;
      diceIsOnSkull = _appJs.x;
      useDiceCursedIds = _appJs.y;
      symbolIsSkull = _appJs.z;
      useCurrentCardId = _appJs.A;
      isOneSkullCard = _appJs.B;
      SYMBOL_SKULL = _appJs.C;
      isTwoSkullsCard = _appJs.D;
      useScoreMarked = _appJs.E;
      isChestCard = _appJs.F;
      useAnimationsDisabled = _appJs.G;
      useIsOnSkullIsland = _appJs.H;
      mixDeck = _appJs.I;
      useCurrentCardActivated = _appJs.J;
      addLoadedListener = _appJs.K;
      isFocusable = _appJs.L;
      getStyleValue = _appJs.M;
      isDocumentElement = _appJs.N;
      useMainDomNode = _appJs.O;
      symbolCoinUrl = _appJs.P;
      symbolDiamondUrl = _appJs.Q;
      getDocumentScroll = _appJs.R;
      symbolToImageUrl = _appJs.T;
      SYMBOLS = _appJs.U;
      symbolIsMonkey = _appJs.V;
      symbolIsParrot = _appJs.W;
      symbolIsCoin = _appJs.X;
      symbolIsDiamond = _appJs.Y;
      cardToImageUrl = _appJs.Z;
      cardToSmallImageUrl = _appJs._;
      cardDefaultUrl = _appJs.$;
      symbolSkullUrl = _appJs.a0;
      isWitchCard = _appJs.a1;
      addDomEventListener = _appJs.a2;
      useDiceDomNode = _appJs.a3;
      useDiceDomNodeSetter = _appJs.a4;
      useWitchCardEffectUsed = _appJs.a5;
      useRoundStarted = _appJs.a6;
      CARD_TWO_SWORDS_CHALLENGE = _appJs.a7;
      useGameStarted = _appJs.a8;
      defaultState = _appJs.a9;
      swFacade = _appJs.aa;
      useSoundDisabled = _appJs.ab;
      symbolMonkeyUrl = _appJs.ac;
      useMainDomNodeSetter = _appJs.ad;
      useGameCreated = _appJs.ae;
    }],
    execute: function () {
      cache = new Map();
      Status = {
