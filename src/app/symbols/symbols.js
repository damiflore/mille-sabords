const symbolCoinUrl = new URL("../dices/dice_coin.png", import.meta.url)
const symbolDiamondUrl = new URL("../dices/dice_diamond.png", import.meta.url)
const symbolMonkeyUrl = new URL("../dices/dice_monkey.png", import.meta.url)
const symbolParrotUrl = new URL("../dices/dice_parrot.png", import.meta.url)
const symbolSkullUrl = new URL("../dices/dice_skull.png", import.meta.url)
const symbolSwordUrl = new URL("../dices/dice_sword.png", import.meta.url)
